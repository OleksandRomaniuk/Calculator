...
class ScriptElementExecutorFactoryImpl implements ScriptElementExecutorFactory {
    ...
    ScriptElementExecutorFactoryImpl() {
        ...
        executors.put(ScriptElement.BOOLEAN_EXPRESSION, () ->
                new ActionExecutor<>(
                        ExpressionMachine.create(
                                ...
                                new ExecutorProgramElementTransducer(ScriptElement.BOOLEAN_OPERAND, this)
        ...
        executors.put(ScriptElement.BOOLEAN_OPERAND, () -> new ActionExecutor<>(
                BooleanMachine.create(this, errorMessage -> {
                    throw new ExecutionException(errorMessage);
                })
        ));
